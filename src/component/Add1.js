...
function Add1() {
  ...
  const handleSkills = (value) => {
    setdata({
      ...data,
      skill: data.skill.includes(value)
        ? data.skill.filter((val) => val !== value)
        : [...data.skill, value],
    });
  };
  ...
  const removeExperience = (index) => {
    ...
    if (count >= 1) {
      setdata({
        ...data,
        experiance: data.experiance.filter((dat, ind) => ind !== index),
      });
    } else {
      alert();
    }
                ...
                <div className="mb-3">
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      type="checkbox"
                      value={"Angular"}
                      checked={data.skill.includes("Angular")}
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      type="checkbox"
                      value={"React"}
                      checked={data.skill.includes("React")}
                      onChange={(e) => handleSkills(e.target.value)}
                    />
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      type="checkbox"
                      value={"Node.JS"}
                      checked={data.skill.includes("Node.JS")}
                      onChange={(e) => handleSkills(e.target.value)}
                    />
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      type="checkbox"
                      value="JavaScript"
                      checked={data.skill.includes("JavaScript")}
                      onChange={(e) => handleSkills(e.target.value)}
                    />
                  ...
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      type="checkbox"
                      value={"Flutter"}
                      checked={data.skill.includes("Flutter")}
                      onChange={(e) => handleSkills(e.target.value)}
                    />
