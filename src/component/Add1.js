...
function Add1() {
    ...
    const [candidate, setcandidate] = useState(JSON.parse(localStorage.getItem("list")) ?
    ...
    const handleSubmit = () => {
        ...
        if (data.skill.length < 3) {
            alert("Minimum 3 Skills you have to selet")
            return
        }
        console.log(data.skill.length);
                        ...
                        <div className="row g-3">
                            <div className="col-sm-6">
                                ...
                                <input
                                    type="text"
                                    className={
                                        data.firstname ? "form-control is-valid"
                            ...
                            <div className="col-sm-6">
                                ...
                                <input
                                    type="text"
                                    className={
                                        data.lastname ? "form-control is-valid"
                                            : "form-control is-invalid"
                                    }
                                    value={data.lastname}
                                    onChange={(e) =>
                            ...
                            <div className="col-12">
                                ...
                                <input
                                    type="email"
                                    className={
                                        data.Email ? "form-control is-valid"
                                            : "form-control is-invalid"
                                    }
                            ...
                            <div className="col-12">
                                ...
                                <textarea
                                    className={
                                        data.Address ? "form-control is-valid"
                                            : "form-control is-invalid"
                                    }
                            ...
                            <div className="col-md-5">
                                ...
                                <select
                                    className={
                                        data.country ? "form-control is-valid"
                                            : "form-control is-invalid"
                                    }
                                    value={data.country}
                                    onChange={(e) =>
                            ...
                            <div className="col-md-4">
                                ...
                                <select
                                    className={
                                        data.State ? "form-control is-valid"
                                            : "form-control is-invalid"
                                    }
                                    value={data.State}
                            ...
                            <div className="col-md-3">
                                ...
                                <input
                                    type="text"
                                    className={
                                        data.Pin ? "form-control is-valid"
                                            : "form-control is-invalid"
                                    }
                                    value={data.Pin}
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="row g-3">
                                                        <div className="col-6">
                                                            ...
                                                            <input type="text" className="form-control" value={data.companyName}
                                                                name="companyName"
                                                        ...
                                                        <div className="col-6">
                                                            ...
                                                            <input type="number" className="form-control" value={data.Duration}
                                                                name="Duration"
                                                                onChange={(e) => handleExperiance(e, index)}
                                                                required />
                                                        </div>
                                                        <div className="col-12">
                                                            ...
                                                            <textarea className="form-control" value={data.responsibilities}
